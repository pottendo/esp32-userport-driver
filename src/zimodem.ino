...
#define ZIMODEM_VERSION "3.6.3PAR"
...
#define DEFAULT_PIN_DCD GPIO_NUM_22 // was 14
#define DEFAULT_PIN_CTS GPIO_NUM_21 // was 13
#define DEFAULT_PIN_RTS GPIO_NUM_19 // was 15 unused
